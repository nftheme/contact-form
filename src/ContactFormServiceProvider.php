...
class ContactFormServiceProvider extends ServiceProvider
{
    ...
    public function initDirectoriesAndFiles()
    {
        ...
        if (!file_exists(get_stylesheet_directory() . '/database/migrations/2018_01_01_000000_create_form_status_table.php')) {
            copy(get_stylesheet_directory() . '/vendor/garung/contact-form-for-nftheme/src/database/migrations/2018_01_01_000000_create_form_status_table.php', get_stylesheet_directory() . '/database/migrations/2018_01_01_000000_create_form_status_table.php');
        }
    ...
    public function handle()
    {
        ...
        if (!empty($request)) {
            ...
            $contact->curr_status_id = $status['status'];
            $result                  = $contact->save();
            if ($result) {
